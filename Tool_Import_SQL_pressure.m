function [timestamp,Pressure] = Tool_Import_SQL_pressure(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [TIMESTAMP,PRESSURE] = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   [TIMESTAMP,PRESSURE] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads
%   data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [timestamp,Pressure] = importfile('pressure_2016-08-21.matlab.csv',1, 17320);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/08/24 13:45:11
